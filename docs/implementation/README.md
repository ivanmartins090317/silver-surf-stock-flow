...
Registro do que **já foi entregue**. O que falta: [`docs/state/PENDENCIAS.md`](../state/PENDENCIAS.md).
...
**Regra:** ao fechar fase, adicionar arquivo aqui, capítulo em `manual-dev/` e atualizar `PENDENCIAS.md`.
